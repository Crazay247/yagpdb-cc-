	...
	*/}}
	...
	{{$Suggestion_Channel:=768699013401673729 }}
	{{$Logging_Channel:=768699013401673729}}
	{{$Implemented_Channel:=768699013401673729}}
	{{$Approved_Channel:=614131951200370710}}
	{{$Mod_Roles:=cslice 353903054405500939 419970533069815808}}{{/* No need to add Admin roles. They are automatically detected given Yag has right Perms */}}
